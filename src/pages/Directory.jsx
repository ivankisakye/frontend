    ...
    <div className="min-h-screen bg-white">
      <div className="bg-black text-white py-14 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-black mt-2 mb-3">Hotel Directory</h1>
          <p className="text-gray-400 max-w-xl">
            Find the perfect place to stay across Uganda's top destinations.
          </p>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 text-gray-400">
            ...
            <p className="text-sm">No hotels listed yet.</p>
          </div>
        ) : (
