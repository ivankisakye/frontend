    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-black text-white px-6 py-4 flex items-center justify-between sticky top-0 z-40 shadow">
        <h1 className="text-uganda-yellow font-black text-lg">
          ...
          <span className="text-gray-400 font-normal text-sm ml-2">New Post</span>
        </h1>
        <Link
          to="/admin/dashboard"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 space-y-5">
              <div className="bg-white rounded-2xl shadow-sm p-6 space-y-5">
                <h2 className="font-bold text-gray-900 text-lg">Post Content</h2>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-5">
                ...
                <Field label="Image URL" hint="paste a link">
                  <input
                    type="text"
                    name="image_url"
